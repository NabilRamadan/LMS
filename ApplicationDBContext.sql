...
VALUES (N'44d38064-3665-4d4a-9e47-c8cb171e7c8e', NULL, N'ApplicationUserRole', N'Admin', N'Admin'),
(N'87b7f7bd-bd54-4c8f-bad4-0339f7474b2c', NULL, N'ApplicationUserRole', N'User', N'User');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'ConcurrencyStamp', N'Discriminator', N'Name', N'NormalizedName') AND [object_id] = OBJECT_ID(N'[AspNetRoles]'))
